...
function infoRow(label: string, value: string): string {
  ...
  const prefix = `  ${c.white}${B}${label}${R} ${dots} ${c.yellow}${value}${R}`;
...
export function printStartup(client: Client): void {
  ...
  const cmdCount = getCommands().size;
  ...
  console.log(border("┌", "─", "┐", c.yellow));
  console.log(centerLine(`${c.yellow}${B}Shaked Music Bot${R}`, c.yellow));
  console.log(border("└", "─", "┘", c.yellow));
  ...
  console.log(infoRow("Commands", `${cmdCount} loaded`));
  console.log(border("└", "─", "┘", c.gray));

  console.log();
  console.log(statusLine(`Online as ${c.yellow}${B}${tag}${R}`));
  console.log(statusLine(`Serving ${c.yellow}${B}${guilds}${R}${c.white} guild${guilds !== 1 ? "s" : ""} with ${c.yellow}${B}${users.toLocaleString()}${R}${c.white} members`));
  console.log(statusLine(`${c.yellow}${B}${cmdCount}${R}${c.white} slash commands registered`));
  console.log();
...
export function printDeployHeader(): void {
  ...
  console.log(border("┌", "─", "┐", c.yellow));
  console.log(centerLine(`${c.yellow}${B}Shaked Music Bot${R}`, c.yellow));
  console.log(centerLine(`${c.gray}${D}Command Deployer${R}`, c.yellow));
  console.log(border("└", "─", "┘", c.yellow));
  console.log();
}

export function printDeployProgress(count: number): void {
  console.log(`  ${c.yellow}${B}⟳${R} ${c.white}Registering ${c.yellow}${B}${count}${R}${c.white} slash commands...${R}`);
}

export function printDeploySuccess(count: number, target: string): void {
  console.log(`  ${c.green}${B}✓${R} ${c.white}Successfully registered ${c.yellow}${B}${count}${R}${c.white} commands ${c.gray}${D}(${target})${R}`);
  console.log();
  console.log(`  ${c.gray}${D}Developed by ${c.white}${B}Shaked Angel${R}  ${c.gray}${D}·  github.com/ddex3${R}`);
  console.log();
}
